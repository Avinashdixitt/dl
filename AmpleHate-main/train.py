...
def train(log):
    ...
    if "ihc" in log.param.dataset:
        train_loader = get_dataloader(f"./data/{log.param.dataset}/train.tsv", tokenizer, ner_tagger=ner_tagger, use_ner=False,  batch_size=log.param.train_batch_size, seed=log.param.SEED)
